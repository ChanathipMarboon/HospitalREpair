    ...
    <body>
        ...
        <section class="home-section" >
            ...
            <div style ="background-color:#81559d;box-shadow: 5px 5px #4a4a4a;">
                <div class="text" style ="font-size:30px;color:white;">ประวัติการแจ้งซ่อมทั้งหมด</div style="padding:30px;"></div>
            </div><br>
        ...
        <div style="border-style: ridge;">
            ...
            <table class="table  table-striped table-hover table-borderless" id="data_table" >
                <thead >
        ...
        $sql =  "SELECT * FROM `notify_repair` where   NOT status_repair ='ยกเลิก' AND username =$username \n". "ORDER BY `notify_repair`.`day_take` DESC;";
        ...
        if(isset($_POST['search_total'])){
            ...
            if (mysqli_num_rows($result_total) > 0) {
                ...
                <script type="text/javascript" charset="utf8" src="https://cdn.datatables.net/1.11.5/js/jquery.dataTables.js"></script>
                        <tr>
                            ...
                            <td><a href='detail.php?detail=<?php echo $row['id'];?>' ><span class='fas fa-clipboard-list fa-2x' style='color:black;margin-left:60px;'></span></a></td>
                            <?php 
                                if($status_repair=="รอดำเนินการ"){
                                    ?>
                                <td><a href='edit.php?update_repair=<?php echo $row['id'];?>' ><span class='fas fa-edit fa-2x' style='color:black;margin-left:60px;'></span></a></td>
                                <td><a href='edit.php?cancel=<?php echo $row['id'];?>' onclick="return confirm('ยืนยันที่จะยกเลิกการซ่อมใช่หรือไม่')"><span class='fas fa-trash-alt fa-2x ' style='color:black;margin-left:80px;'></span></a></td>
                                <?php
                                }else{
                                    ?>
                                    <td></td>
            ...
            $date_s = $_POST['date_s'];
            $date_e = $_POST['date_e'];
            $sql = "SELECT * FROM `notify_repair` where day_take BETWEEN '$date_s' AND '$date_e'AND  NOT status_repair ='ยกเลิก' AND username =$username";
                ...
                while($row = mysqli_fetch_assoc($result)) {
                    ...
                    <script type="text/javascript" charset="utf8" src="https://cdn.datatables.net/1.11.5/js/jquery.dataTables.js"></script>
                            <tr>
                                ...
                                <td style ='text-align:center;'><?php echo $row["note"] ;?></td> 
                                <td style ='text-align:center;'><?php echo $status_repair;?></td>
                                <td style ='text-align:center;'><a href='detail.php?detail=<?php echo $row['id'];?>' ><span class='fas fa-clipboard-list fa-2x' style="color:black;"></span></a></td>
                               <?php 
                                if($status_repair=="รอดำเนินการ"){
                                    ?>
                                <td><a href='edit.php?update_repair=<?php echo $row['id'];?>' ><span class='fas fa-edit fa-2x' style='color:black;margin-left:60px;'></span></a></td>
