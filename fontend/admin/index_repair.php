...
<?php if (!isset($_SESSION['user_level'])) header("location: ../../login/loginn.php");  ?>
    ...
    <section class="home-section">
        ...
        if(isset($_POST['search'])){ 
            ...
            <!-- บันทึกการเเจ้งซ่อม !-->
            <form action="../../backend/qury_admin/noti_repair.php" method="POST">
                <br>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="customer" value="<?php echo $locates?>" style="width: 500px; border: 0px; border-bottom: 1px solid black">
                </div>
        
                <div class="form-group">
                    <label style="font-size:18px;">หมายเหตุ/อาการเสีย</label><br>
                    <input type="text" name="note" style="width: 500px;border: 0px; border-bottom: 1px solid black" id="validationCustomnote" required>
                </div>
                <br>
